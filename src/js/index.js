...
startBtn.addEventListener('click', () => {
  if(validaForm()){
    if(document.querySelector('#choose').value !== '' && document.querySelector('#search').value){
      loadEvents(document.querySelector('#search').value, document.querySelector('#choose').value);
    // searchInput.value = ''; //eliminar contenido
    }else if(!document.querySelector('#search').value && document.querySelector('#choose').value){
